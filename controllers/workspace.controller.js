...
export const deleteWorkspace = async (req, res) => {
    try {
        ...
        await TelegramConnection.deleteMany({ workspace_id: id });
        await InstagramConnection.deleteMany({ workspace_id: id });
        await FacebookConnection.deleteMany({ workspace_id: id });
